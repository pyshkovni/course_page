# Python Base — методическое пособие для студентов бакалавриата по изучению основ Python и применению их на практике
...
* телеграм-бот и необходимые фреймворки: aiogram, работа с внешним API, асинхронность, много поточность;
* логирование и тестирование;
* Администрирование Linux-сервера: ssh-протокол, виртуальные машины, docker-контейнеры.
